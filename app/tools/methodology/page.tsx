...
export default function ToolsMethodologyPage() {
  ...
  return <main>
    ...
    <div className="page-copy shell">
      ...
      <p>Tender-alert products use the same feature definitions for AI or semantic matching, buyer and supplier profiles, renewals, similar contracts, buyer-document corpora, buyer requirements, requirements planning, award history and related workflow capabilities. A buyer-document corpus means searchable buyer-authored material such as plans, budgets, minutes, strategies or pipelines that can reveal upcoming work; tender attachments alone do not qualify. <strong>Yes</strong> requires clear first-party evidence that the complete capability is offered in at least one current plan. Higher-plan gating is shown separately and does not make a complete capability partial. <strong>Partial</strong> means the implementation is adjacent, incomplete, indirect, pilot-only or materially narrower. <strong>Not offered</strong> is the default when the reviewed public product pages do not establish the capability.</p>
      ...
      <p>The tender-alert comparison groups products into full intelligence, intelligence plus workflow, smart matchers and lite alerting. Classification is mechanical and types overlap: one product may be both full intelligence and workflow, for example. Full-intelligence products need at least five clearly evidenced intelligence capabilities plus a resolved buyer or supplier profile. Workflow products need at least two workflow capabilities alongside intelligence or requirements planning. Products with clear AI matching or moderate intelligence depth become smart matchers. Products that meet none of those tests are lite alerting.</p>
      <p>The combined shortlist score is 68% feature depth and 32% headline value. The feature score uses all 14 normalized capabilities and totals 100 possible points. AI matching, buyer profiles and renewals each carry 12 points; supplier profiles, similar contracts, buyer requirements, requirements planning and award history each carry 8; buyer-document corpus carries 6; and frameworks and workflow features carry the balance. A partial capability receives 45% of its feature weight.</p>
      <p>Headline value uses two affordability benchmarks: 45% of the affordability component comes from the entry plan that offers the relevant tender-alert or matching capability, and 55% from the highest listed package. A free search-only or limited plan is still shown in the pricing table but is not used as a free tracking benchmark. The total value calculation gives 55% to that blended affordability, 25% to whether numeric pricing is public, and 20% to whether billing is per seat, team or organisation. Annual monthly equivalents are used where published. Quote-only and unpublished prices receive a neutral-low affordability value rather than being treated as free. The entry plan may not contain every scored feature, the highest listed package may still require add-ons, currencies are not converted, and implementation quality is not tested. Buyers must compare the actual plans and order form before purchase.</p>

...
export default function ToolsMethodologyPage() {
  ...
  return <main>
    ...
    <div className="page-copy shell">
      ...
      <p>All entries in this release were last checked on <time dateTime="2026-08-12">12 August 2026</time>. Public pages can change at any time, so buyers should obtain a dated order form before purchase. Where a provider page contradicts itself, we say so rather than choosing the more convenient figure.</p>
